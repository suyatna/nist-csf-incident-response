...
Insiden DoS yang dialami organisasi multimedia ini memperlihatkan dampak nyata dari kelemahan konfigurasi keamanan jaringan terhadap ketersediaan layanan bisnis. Banjir paket ICMP yang lolos dari firewall membuat jaringan internal berhenti beroperasi sementara waktu. Aktivitas karyawan dan layanan yang bergantung pada koneksi jaringan ikut terganggu.

Analisis menggunakan NIST Cybersecurity Framework memberi gambaran utuh tentang alur penanganan keamanan, mulai dari mengenali risiko, melindungi aset, mendeteksi ancaman, merespons insiden, hingga memulihkan sistem. Penerapan kontrol seperti pembatasan lalu lintas ICMP, validasi alamat IP, pemantauan jaringan, dan penggunaan IDS/IPS terbukti membantu menahan serangan serta mengembalikan layanan penting secara bertahap.

Studi kasus ini menegaskan bahwa keamanan jaringan perlu dibangun secara proaktif dan berkelanjutan. Respons saat insiden terjadi saja tidak cukup. Konfigurasi yang tepat, pemantauan aktif, dan evaluasi rutin terhadap kontrol keamanan menjadi kunci utama. Pendekatan yang selaras dengan NIST CSF membantu organisasi memperkuat ketahanan jaringan, menekan dampak serangan di masa depan, dan menjaga kepercayaan pengguna serta stabilitas operasional jangka panjang.
